...
let filmActuel = filmsDatabase[0];
let filmsAffichés = [...filmsDatabase];
...
// Ajouter de la pagination (optionnel)
function addPaginationToCarousel() {
    // Cette fonction peut être étendue pour ajouter des contrôles de pagination
}
